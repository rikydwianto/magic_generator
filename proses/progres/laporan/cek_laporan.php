...
<div class="col-lg-12 col-sm-12">
    <form action="" method="post">
        ...
        <div class="row g-3  mb-3">
            ...
            ?>
                <div class="col">
                    ...
                    <input type="number" <?= $disabled ?> value="<?= $json[$kode] ?>" oninput="hitungTotalPinjaman()" class="form-control" id="pinjaman<?= $kode ?>" name="pinjaman[<?= $kode ?>]" min="0">
                </div>
            <?php
        ...
        ?>
            <button type="submit" value='simpan' name='approve' onclick="return window.confirm('Apakah yakin akan menyetujui laporan ini?')" class="btn btn-success"><i class="fa fa-check"></i> APPROVE</button>
            <button type="submit" value='pending' name='reject' onclick="return window.confirm('Apakah yakin akan Reject laporan ini?')" class="btn btn-danger"><i class="fa fa-times"></i> REJECT</button>
        <?php
        }
        ?>
