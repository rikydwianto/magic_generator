...
<form action="" method="post">
    ...
    <div class="mb-3">
        ...
        <input type="text" value='<?= $kuis['nama_kuis'] ?>' disabled class="form-control" id="nama_kuis_lama" name="nama_kuis_lama" placeholder="Masukkan Nama Kuis Lama" required>
    </div>
    <div class="mb-3">
        <label for="nama_kuis_baru" class="form-label">Nama Kuis Baru</label>
        <input type="text" value='<?= $kuis['nama_kuis'] ?>' class="form-control" id="nama_kuis_baru" name="nama_kuis_baru" placeholder="Masukkan Nama Kuis Baru" required>
    </div>
