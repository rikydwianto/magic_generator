...
<body>
    ...
    <div class="row m-2">
        <div class="container">
            ...
            <div class="row">
                ...
                ?>
                        <div class="col-lg-3">
                            <label for="jenisTestFilter">Filter Jenis Test:</label>
                            <select class='form-select' id="jenisTestFilter">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Terapkan filter setelah perubahan pada dropdown
            $('#jenisTestFilter').on('change', function() {
